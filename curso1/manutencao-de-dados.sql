...
INSERT INTO [tb produtos] 
([Codigo do produto], [Nome do produto], Embalagem, Tamanho, Sabor, [preco de lista])
VALUES ('788975', 'Pedaços de frutas - 1,5 litros - maçã', 'PET', '1,5 litros', 'Maçã', 18.01); 
...
-- Ordem dos campos - não é necessário colocar o nome dos campos, desde que esteja na mesma ordem que foi criado na tabela
-- se não for colocado na ordem, tem que colocar o nome dos campos
INSERT INTO [tb produtos] 
